...
public class FullShapeletTransform extends SimpleBatchFilter {
	...
	public static void main(String[] args) {
		// String[] problems = {
		// "Adiac","Beef","ChlorineConcentration","Coffee","DiatomSizeReduction","ECGFiveDays","FaceFour","GunPoint","ItalyPowerDemand","Lightning7","MedicalImages","MoteStrain","Symbols","SyntheticControl","Trace","TwoLeadECG"
		// };
		String[] problems = { "ChlorineConcentration", "Coffee", "ECGFiveDays", "GunPoint", "Lightning7", "MedicalImages", "MoteStrain", "Trace", "TwoLeadECG" };

		// String[] problems = { "Coffee", "GunPoint", "ItalyPowerDemand",
		// "Lightning7", "Symbols" };
		// String[] problems = { "Lightning7","ECG200", "Wine", "Car", "Symbols"
		// };
		// String[] problems={"GunPoint"};
